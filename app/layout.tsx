...
export const metadata: Metadata = {
  ...
  title: {
    // 56 chars — well under Google's ~60-char SERP cut, leads with the
    // two highest-intent terms ("checker", "finder"), brand suffix
    // adds Companies-House credibility without truncation.
    default: 'Free UK Company Name Checker & Finder — Companies House',
    template: '%s | UK Company Name Check',
  },
  description:
    'Brainstorm a UK company name with AI and instantly verify it against the live Companies House register. Schedule 3 same-as rules, dissolved-name flags, free.',
  keywords: [
  ...
  openGraph: {
    ...
    title: 'Free UK Company Name Checker & Finder — Companies House',
    description:
      'Brainstorm a UK company name with AI and instantly verify it against the live Companies House register. Schedule 3 same-as rules. Free.',
    // The actual image is generated by app/opengraph-image.tsx — Next
    // injects og:image, og:image:width, og:image:height and og:image:alt
    // for that file automatically. Listing it here as well makes the
    // explicit URL available to crawlers that don't use the convention.
    images: [
      {
        url: '/opengraph-image',
        width: 1200,
        height: 630,
        alt: 'Free UK Company Name Checker & Finder — Companies House',
        type: 'image/png',
      },
    ],
  },
  twitter: {
    ...
    site: '@companynamecheck',
    title: 'Free UK Company Name Checker & Finder — Companies House',
    description:
      'Brainstorm a UK company name with AI and instantly verify it against Companies House. Schedule 3 same-as rules. Free.',
    images: [
      {
        url: '/opengraph-image',
        alt: 'Free UK Company Name Checker & Finder — Companies House',
  ...
  // Hint to crawlers what country/language this site targets.
  other: {
    'geo.region': 'GB',
